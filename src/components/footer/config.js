...
const workLinks = {
	...
	header: 'Work',
	links: [
		{ icon: faGithubSquare, label: 'github', anchor: { href: links.github, target: '_blank' } },
		{ icon: faLinkedin, label: 'linkedIn', anchor: { href: links.linkedIn, target: '_blank' } },
		{ icon: faEnvelope, label: links.mail, anchor: { href: '#footer', className: 'dead-anchor' } },
		{ icon: faFileAlt, label: ' Resume', anchor: { href: links.cv, target: '_blank' } }
	]
}
...
const personalLinks = {
	...
	header: 'Personal',
	links: [
		{ icon: faFacebook, label: 'facebook', anchor: { href: links.fb, target: '_blank' } },
		{ icon: faYoutubeSquare, label: 'youtube', anchor: { href: links.uTube, target: '_blank' } },
		{ icon: faPhoneSquare, label: links.phone, anchor: { href: '#footer', className: 'dead-anchor' } },
		{ icon: faInstagram, label: 'instagram', anchor: { href: links.instagram, target: '_blank' } }
	],
}
