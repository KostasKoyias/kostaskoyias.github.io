...
export const getRepoIcon = (repo) => {
  const icon = isThisRepo(repo) ? faGlobe : repo.watchers > 0 && faStar;
...
export const getRepoUrl = (repo) =>
  repo.homepage && !isThisRepo(repo) ? repo.homepage : repo.html_url || repo.links.html.href;
